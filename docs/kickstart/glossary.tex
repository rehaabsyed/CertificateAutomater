...
\newglossaryentry{crit-path}{
    name={critical path},
    description={The path of tasks from start to end of a project with no slack time.}
}

\newglossaryentry{slack-time}{
    name={slack time},
    description={Time in a path of tasks in which the subsequent task cannot be completed due to a dependent task in another path.}
}

\newglossaryentry{spiral}{
    name={spiral},
    description={Project management methodologies comprised of cycles of rapid prototyping and reviews.}
}

\newglossaryentry{agile}{
    name={agile},
    description={Spiral project management methodologies using the 12 principles of agile.}
}

\newglossaryentry{scrum}{
    name={Scrum},
    description={Agile project management methodology comprised of small teams, short sprints, sprint reviews.}
}

\newglossaryentry{scrum-master}{
    name={Scrum master},
    description={The person in charge of ensuring Scrum is used in a team.}
}

\newglossaryentry{sprint}
    name={sprint},
    description={A fixed period of time in Scrum where a small set of tasks are prioritised.}
}

\newglossaryentry{kanban}
    name={Kanban},
    description={Japanese for notice, a board with columns for managing the tasks of a project from not started to done.}
}

...
If the docstrings are updated, then the command \mintinline{shell}{make html} can be rerun to update the HTML files. Fortunately, the reStructedText files refer to the docstrings instead of copying them, meaning they do not need to be recreated.
